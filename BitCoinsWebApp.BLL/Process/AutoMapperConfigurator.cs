namespace BitCoinsWebApp.BLL.Process
{
    ...
    public class AutoMapperConfigurator
    {
        ...
        public class MappingProfile : Profile
        {
            ...
            {
                CreateMap<UserAccount, UserProfile>().ForMember(x => x.ListRef, opt => opt.Ignore()).ForMember(x => x.ListUserLevel1, opt => opt.Ignore()).ForMember(x => x.ListUserLevel2, opt => opt.Ignore()).ForMember(x => x.BalanceAmount, opt => opt.Ignore()).ForMember(x => x.ListUserOneRef, opt => opt.Ignore()).ForMember(x => x.ListUserTwoRef, opt => opt.Ignore()).ForMember(x => x.NewPassword, opt => opt.Ignore()).ForMember(x => x.ConfirmPassword, opt => opt.Ignore()).ForMember(x => x.ImageURL, opt => opt.Ignore()).ReverseMap();
                CreateMap<UserProfile, UserAccount>().ForMember(x => x.ImageProfile, opt => opt.Ignore()).ReverseMap();
