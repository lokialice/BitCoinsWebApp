...
namespace BitCoinsWebApp.Utilities
{
    public class CalTime
    {
        ...
        public CalTime(DateTime Bday)
        {
            this.Count(Bday);
        }

        public CalTime(DateTime Bday, DateTime Cday)
        {
            this.Count(Bday, Cday);
        }

        public CalTime Count(DateTime Bday)
        {
            return this.Count(Bday, DateTime.Today);
        }

        public CalTime Count(DateTime Bday, DateTime Cday)
        {
